...
from DVProcessing.app import create_app
from DVProcessing.database import db
from DVProcessing.settings import DevConfig, ProdConfig
from DVProcessing.user.models import User

CONFIG = ProdConfig if os.environ.get('DVPROCESSING_ENV') == 'prod' else DevConfig
